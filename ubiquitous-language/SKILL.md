...
description: This skill should be used when the user wants to extract a DDD-style ubiquitous language glossary from the current conversation. Triggers on "ubiquitous language", "domain glossary", "extract domain terms", "DDD glossary", "define domain terminology", "harden terminology", or "domain model".
---
