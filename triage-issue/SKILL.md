---
name: triage-issue
description: This skill should be used when the user wants to investigate a bug or issue by exploring the codebase to find the root cause, then create a GitHub issue with a TDD-based fix plan. Triggers on "triage this bug", "investigate issue", "root cause analysis", "triage", "diagnose this problem", or when the user reports a bug and wants a structured fix plan.
---
...
Use the Agent tool with subagent_type=Explore to deeply investigate the codebase. The goal is to find:
...
If `gh` is not available or the user prefers local output, write the issue content to a markdown file instead.
