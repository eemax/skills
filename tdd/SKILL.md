---
name: tdd
description: This skill should be used when the user wants to build features or fix bugs using test-driven development. Triggers on "TDD", "test driven development", "red green refactor", "write tests first", "test-first development", or when the user wants integration-style behavioral tests.
---
